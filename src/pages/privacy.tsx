  ...
  return (
    <Layout title="Privacy">
      <GrayContainer paddingY>
        <MaxWidthContainer>
          {' '}
          <h1>Privacy Policy</h1> <p>Updated at 2022-05-16</p>{' '}
          <p> Ecommerce.</p>
          <p>
            <span>
          ...
          <div>
            <p>
              <span>This Privacy Policy applies to our website,</span>
            </p>
            <p>
              <span> https://ecommerce-platzi-api.vercel.app/</span>
            </p>
            <p>
              <span>
          ...
          <ul>
            <li>
              <span>
                ...
                website and saved by your web br/owser. It is used to identify
                your br/owser, provide analytics, remember information about you
            ...
            <li>
              <span>
                ...
                <a href="https://ecommerce-platzi-api.vercel.app/">Ecommerce</a>
            ...
            <li>
              <span>
                ...
                <a href="https://ecommerce-platzi-api.vercel.app/">
                  Ecommerce
                </a>{' '}
                ...
                are based, in this case is Mexico.
                <br />
              </span>
            </li>
            <li>
            ...
            <li>
              <span>
                ...
                <a href="https://ecommerce-platzi-api.vercel.app/">
                  https://ecommerce-platzi-api.vercel.app/.
                </a>
                <br />
              </span>
            </li>
          ...
          <p>
            <span>
              We are incorporated in Mexico. Information collected via our
          ...
          <p>
            <span>
              ...
              destroyed by a br/each of any of our physical, technical, or
          ...
          <p>
            <span>
              The laws of Mexico, excluding its conflicts of law rules, shall
          ...
          <p>
            <span>
              ...
              effect. Your br/owsing and interaction on any other website,
          ...
          <p>
            <span>
              ...
              your computer or mobile device by your web br/owser. We use
              Cookies to personalize the Content that you see on our website.
              Most web br/owsers can be set to disable the use of Cookies.
